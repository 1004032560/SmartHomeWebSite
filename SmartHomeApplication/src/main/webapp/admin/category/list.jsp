...
<script type="text/javascript">
			function del(id){
				if(confirm("你确认删除吗?")){
					location.href ="${pageContext.request.contextPath}/adminCategory/del?id="+id;
				}
			}
			...
			function query(){
				var name=$("#name").val();
				window.location.href = "${pageContext.request.contextPath}/adminCategory/list?name="+name;
			}
			function fenye(curPage){
				var name=$("#name").val();
				window.location.href = "${pageContext.request.contextPath}/adminCategory/list?name="+name+"&curPage="+curPage;
			}
		</script>
</HEAD>
<body>
						...
						<c:forEach items="${page.list}" var="entry" varStatus="status">
							<tr onmouseover="this.style.backgroundColor = 'white'"
								...
								<td align="center" style="HEIGHT: 22px"><a
									href="${ pageContext.request.contextPath }/adminCategory/getById?id=${entry.id}">
										<img
