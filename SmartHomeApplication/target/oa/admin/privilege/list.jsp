...
<HTML>
	<HEAD>
		...
		<script type="text/javascript">
			function del(id){
				if(confirm("你确认删除吗?")){
				    window.location.href = "${pageContext.request.contextPath }/adminPrivilege/del?id="+id;
				}
			}
			function add(){
				window.location.href = "${pageContext.request.contextPath}/admin/privilege/add.jsp";
			}
			
			function fenye(curPage){
				var name=$("#name").val();
				window.location.href = "${pageContext.request.contextPath}/adminPrivilege/list?name="+name+"&curPage="+curPage;
			}
		</script>
	</HEAD>
	<body>
									...
									<c:forEach items="${page.list}" var="entry" varStatus="status">
										<tr onmouseover="this.style.backgroundColor = 'white'"
											...
											<td align="center" style="HEIGHT: 22px">
												<a href="${ pageContext.request.contextPath }/adminPrivilege/getById?id=${entry.id}">
